...
try {
    ...
    if ($arr_payment[0] != "payment") {
        $connect->exec("CREATE TABLE `personnel_department`.`payment` (`id` INT(11) NOT NULL AUTO_INCREMENT, `worker_id` INT(11) NOT NULL,  `name` VARCHAR(255) NULL, `description` TEXT NULL, `price` DOUBLE NULL, `action` VARCHAR(255) NULL, `path` VARCHAR(255) NULL, `path_mini` VARCHAR(255) NULL, `in_stock` INT(11) NULL, PRIMARY KEY (`id`)) ENGINE = InnoDB;" );
    }
